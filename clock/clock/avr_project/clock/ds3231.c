...
extern void init_rtc()
{
	...
	twiBuf[0] = (DS3231_ADR<<1)|0;	//адресный пакет
	twiBuf[1] = 0x0E;               //адрес регистра
	twiBuf[2] = 0x00;                 
	twiBuf[3] = 0x00;
	twiMsgSize = 4;
